...
export function Services() {
  return (
    <section id="servicos" className="bg-ideaal-mist py-20 md:py-28">
        ...
        <div className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {services.map((service) => {
            ...
            return (
              <article
                key={service.title}
                className="group rounded-lg border border-slate-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:border-orange-200 hover:shadow-premium"
              >
